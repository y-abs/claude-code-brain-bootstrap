...
Generate a detailed **Claude Squad** parallel execution plan for: $ARGUMENTS

> ultrathink — use extended reasoning for workstream decomposition and dependency analysis.
...
1. Break down $ARGUMENTS into independent subtasks
