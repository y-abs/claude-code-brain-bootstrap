...
Auto-detects in ~2 seconds: project name, languages (with file counts), package manager, runtime, formatter/linter, test framework, build/test/lint/serve/migrate/db/deps commands, security scanner, monorepo tools, CI, database/ORM, Docker, 480+ frameworks, installed plugins.
